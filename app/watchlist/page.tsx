...
async function fetchWatchlist() {
  ...
  return resultsWatchlist;
}

function WatchlistPage() {
  const [watchlistData, setWatchlistData] = useState<PORTFOLIOWATCHLIST[]>([]);

  useEffect(() => {
    const fetchInitialData = async () => {
      const resultsWatchlist = await fetchWatchlist();
  ...
  const refreshDataWatchlist = async () => {
    const newData = await fetchWatchlist();
    const resultsWatchlist = newData;
    setWatchlistData(resultsWatchlist);
  };

  useEffect(() => {
    refreshDataWatchlist;
  }, []);
      ...
      <React.StrictMode>
        ...
        <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
          <div className="col-span-12 xl:col-span-12">
            <WatchlistTable tableData={watchlistData} onSubmitSuccess={refreshDataWatchlist} onDeleteSuccess={refreshDataWatchlist} />
          </div>
        </div>
      </React.StrictMode>
    </>
