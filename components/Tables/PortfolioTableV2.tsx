...
const SellsTableV2: React.FC<TableProps> = ({ tableData, additionalTableData, onSubmitSuccess, onDeleteSuccess }) => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 shadow-default dark:border-simplybackground dark:bg-simplybackground sm:px-7.5 xl:pb-1">
      <div className="border-b border-stroke dark:border-strokedark flex justify-between items-center">
        <h4 className="mb-1 mt-4.5 text-title-xl2 font-semibold text-black dark:text-white">Sells</h4>
        <button
          onClick={openModal}
      ...
      <div className="flex flex-col">
        <div className="mb-1 justify-evenly grid grid-cols-3 rounded-md bg-stockwaveblue font-medium text-white text-center dark:text-bodydark2 dark:bg-simplybackground sm:grid-cols-8">
