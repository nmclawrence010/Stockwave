...
interface AdditionalTableProps {
  ...
  additionalData: PORTFOLIORECORDEXTRA[];
}

const AdditionalTableThree: React.FC<AdditionalTableProps> = ({ tableData, transactionID, additionalData }) => {
      ...
      {filteredTableData.map((data, index) => (
        ...
        >
          <div className="flex items-center gap-3 p-2.5 xl:p-5">
            <p className="hidden text-black dark:text-white sm:block">{data.Ticker}</p>
          </div>
