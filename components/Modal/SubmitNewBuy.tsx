...
import { updateDatabaseItem } from "@/lib/AWSEdit";
...
export default function BuyModal({ openModal, closeModal, userId, onSubmitSuccess, mode = "add", initialData = null }: any) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (mode === "add") {
        ...
        await updateDatabaseItem(initialData.transactionID, userId, {
          stockTicker: enteredTicker,
          numberOfShares: formData.numberOfShares,
          averageCost: formData.averageCost,
          date: formData.date,
