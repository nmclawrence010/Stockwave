...
const CardDataStats: React.FC<CardDataStatsProps> = ({
  ...
  // Determine additional text based on the value of specificCard
  switch (specificCard) {
    case "1":
    ...
    case "3":
      additionalText =
        "Unrealised gain includes dividends <br /> but the percentage does not.";
      break;
    default:
      additionalText = "";
  }
    ...
    <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="mt-4 flex items-end justify-between">
        ...
        <div className="group relative inline-block">
          <span
            className={`flex items-center gap-1 text-m font-medium ${
              levelUp && "text-meta-3"
